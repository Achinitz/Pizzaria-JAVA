...
public class TelaClientePedido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pedidoL2 = new javax.swing.JLabel();
        txtPedidoL2 = new javax.swing.JTextField();
        ...
        incluirCliente.setText("Adicionar");
        ...
        atualizarCliente.setText("Recarregar");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(listarCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(54, 54, 54)
        ...
        tituloCliente.setText("Pizzaria do LaGu");
        ...
        pedidoL2.setText("Lado X (cm²)");

        txtPedidoL2.setText("0");
        txtPedidoL2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtPedidoL2ActionPerformed(evt);
            }
        });
        txtPedidoL2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtPedidoL2KeyReleased(evt);
            }
        });
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(pedidoL2)
                    .addComponent(txtPedidoL2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(pedidoTamanho)
    ...
    private void comboFormaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboFormaActionPerformed
        ...
        if(f.equals("Formato Quadrado")){
            ...
            pedidoL2.setVisible(false);
            txtPedidoL2.setVisible(false);
    ...
    private void inserirItemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_inserirItemMouseClicked
        ...
        if(txtPedidoTelefone.getText().equals("") || txtPedidoL1.getText().equals("") || txtPedidoL2.getText().equals("")){
            ...
            if(achou){
                telefone = txtPedidoTelefone.getText();
                listaDeItens.add(ip);
                tp.adicionaItemPedido(ip);
                calculaPrecoTotal("incluir");
                Double precoT = Double.parseDouble(precoTotal.getText());
                List<ItemPedido> itensPedido = new ArrayList();//teste
                if(novo){
                    itensPedido.add(ip);
                    Pedido p = new Pedido(-1L, telefone, itensPedido, precoT);
                    listaDePedidos.add(p);
                }else{
                    for(i = 0; i < listaDePedidos.size(); i++){
                        if(listaDePedidos.get(i).getTelefone().equals(txtPedidoTelefone.getText())){
                            for(int j = 0; j < listaDePedidos.get(i).getItens().size(); j++){
                                itensPedido.add(listaDePedidos.get(i).getItens().get(j));
                            }
                        }
                    }
                    itensPedido.add(ip);
                    for(i = 0; i < listaDePedidos.size(); i++){
                        if(listaDePedidos.get(i).getTelefone().equals(txtPedidoTelefone.getText())){
                            precoT = listaDePedidos.get(i).getValorTotal() + ip.getPrecoItem();
                            listaDePedidos.get(i).setItens(itensPedido);
    ...
    private void txtPedidoL2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPedidoL2KeyReleased
        if(((txtPedidoL2.getText().length() >= 0) || evt.getKeyCode() == KeyEvent.VK_BACK_SPACE) && !txtPedidoL2.getText().equals("")){
            String forma = (String) comboForma.getSelectedItem();
            if(forma.equals("Formato Quadrado")){
                Forma f = new Quadrado(Double.parseDouble(txtPedidoL1.getText()));
                String cm2 = Double.toString(f.cm2());
    ...
    }//GEN-LAST:event_txtPedidoL2KeyReleased
    ...
    public void calculaLados(){
        ...
        if(f.equals("Formato Quadrado")){
            ...
            String l1 = Double.toString(cm2);
             //String l1 = (String) Math.sqrt(m2);
            txtPedidoL1.setText(l1);
            //txtPedidoL2.setText(l1);
        }else if(f.equals("Formato Triangular")){
        cm2 = Math.sqrt(cm2);
            String l1 = Double.toString(cm2);
            //String l1 = (String) Math.sqrt(m2);
    ...
    private javax.swing.JLabel pedidoL2;
    ...
    private javax.swing.JTextField txtPedidoL2;
